# course0 - 從 0 開始 的程式課程教材

> 從 0 開始： 從底層到上層，從簡單到複雜，從頭建立一台簡易電腦，重現資訊科學中的經典範例。
...
| 課程 | 程式 | 語言 | 主題 |
|------|------|---------|------|
| 計算理論 | [講義](lecture/計算理論/README.md) / [程式](code/計算理論/) / [Wiki](wiki/計算理論/) | Python | 圖靈機 / Lambda Calculus / 語法理論 ... |
| 程式與數學 | [講義](lecture/程式與數學/README.md) / [程式](code/程式與數學/) / [Wiki](wiki/程式與數學/) | 代數 / 幾何 / 微積分 / 機率統計 ... |
