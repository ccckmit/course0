...
- [計算機結構](計算機結構/index.md) - 硬體設計、數位邏輯、CPU 架構 | tags: 硬體, Verilog, RISC-V
- [系統程式](系統程式/index.md) - 編譯器、組合語言、Linux系統、網路、雲端 | tags: 編譯器, OS, Unix
- [演算法](演算法/index.md) - 演算法設計與分析 | tags: 複雜度, 資料結構
