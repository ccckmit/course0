...
# 從命令列參數取得資料檔案路徑
# sys.argv[0] 是腳本名稱，sys.argv[1] 是第一個參數
data_file = sys.argv[1]  # 例如：'chinese.txt'
