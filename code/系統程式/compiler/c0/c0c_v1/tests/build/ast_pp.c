...
static const char *node_kind_name(NodeKind k) {
    switch (k) {
        ...
        case ND_TRANSLATION_UNIT: return "ND_TRANSLATION_UNIT"; case ND_FUNC_DEF: return "ND_FUNC_DEF"; case ND_DECL: return "ND_DECL"; case ND_PARAM: return "ND_PARAM";
        case ND_TYPE_BASE: return "ND_TYPE_BASE"; case ND_TYPE_PTR: return "ND_TYPE_PTR"; case ND_TYPE_ARRAY: return "ND_TYPE_ARRAY"; case ND_TYPE_FUNC: return "ND_TYPE_FUNC";
        case ND_TYPE_STRUCT: return "ND_TYPE_STRUCT"; case ND_TYPE_UNION: return "ND_TYPE_UNION"; case ND_TYPE_ENUM: return "ND_TYPE_ENUM";
        case ND_STRUCT_MEMBER: return "ND_STRUCT_MEMBER"; case ND_ENUMERATOR: return "ND_ENUMERATOR";
        case ND_COMPOUND: return "ND_COMPOUND"; case ND_IF: return "ND_IF"; case ND_WHILE: return "ND_WHILE"; case ND_DO_WHILE: return "ND_DO_WHILE"; case ND_FOR: return "ND_FOR";
        case ND_RETURN: return "ND_RETURN"; case ND_BREAK: return "ND_BREAK"; case ND_CONTINUE: return "ND_CONTINUE"; case ND_GOTO: return "ND_GOTO"; case ND_LABEL: return "ND_LABEL";
        case ND_SWITCH: return "ND_SWITCH"; case ND_CASE: return "ND_CASE"; case ND_DEFAULT: return "ND_DEFAULT";
        case ND_EXPR_STMT: return "ND_EXPR_STMT"; case ND_EMPTY_STMT: return "ND_EMPTY_STMT";
        case ND_ASSIGN: return "ND_ASSIGN"; case ND_TERNARY: return "ND_TERNARY"; case ND_BINARY: return "ND_BINARY";
        case ND_UNARY_PRE: return "ND_UNARY_PRE"; case ND_UNARY_POST: return "ND_UNARY_POST";
        case ND_CAST: return "ND_CAST"; case ND_SIZEOF_EXPR: return "ND_SIZEOF_EXPR"; case ND_SIZEOF_TYPE: return "ND_SIZEOF_TYPE";
        case ND_CALL: return "ND_CALL"; case ND_INDEX: return "ND_INDEX"; case ND_MEMBER: return "ND_MEMBER"; case ND_ARROW: return "ND_ARROW";
        case ND_IDENT: return "ND_IDENT"; case ND_INT_LIT: return "ND_INT_LIT"; case ND_FLOAT_LIT: return "ND_FLOAT_LIT"; case ND_CHAR_LIT: return "ND_CHAR_LIT"; case ND_STR_LIT: return "ND_STR_LIT";
        case ND_INIT_LIST: return "ND_INIT_LIST"; case ND_COMMA_EXPR: return "ND_COMMA_EXPR";
    ...
    switch (n->kind) {
        ...
        case ND_BINARY: {
            ...
            if (n->right && n->right->kind == ND_BINARY) {
                ...
                if (strcmp(op,"||")==0 && strcmp(rop,"&&")==0) rprec = 999;
                if (strcmp(op,"&")==0 &&
                    (strcmp(rop,"+")==0 || strcmp(rop,"-")==0)) rprec = 999;
            }
            if (n->left && n->left->kind == ND_BINARY) {
                const char *lop = n->left->sval ? n->left->sval : "";
                if (strcmp(op,"||")==0 && strcmp(lop,"&&")==0) lprec = 999;
                if (strcmp(op,"&")==0 &&
                    (strcmp(lop,"+")==0 || strcmp(lop,"-")==0)) lprec = 999;
            }
