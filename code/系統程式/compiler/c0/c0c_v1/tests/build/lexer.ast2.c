...
static const KwEntry KEYWORDS[] = {{"auto", TK_AUTO}, {"break", TK_BREAK}, {"case", TK_CASE}, {"char", TK_CHAR}, {"const", TK_CONST}, {"continue", TK_CONTINUE}, {"default", TK_DEFAULT}, {"do", TK_DO}, {"double", TK_DOUBLE}, {"else", TK_ELSE}, {"enum", TK_ENUM}, {"extern", TK_EXTERN}, {"float", TK_FLOAT}, {"for", TK_FOR}, {"goto", TK_GOTO}, {"if", TK_IF}, {"int", TK_INT}, {"long", TK_LONG}, {"register", TK_REGISTER}, {"return", TK_RETURN}, {"short", TK_SHORT}, {"signed", TK_SIGNED}, {"sizeof", TK_SIZEOF}, {"static", TK_STATIC}, {"struct", TK_STRUCT}, {"switch", TK_SWITCH}, {"typedef", TK_TYPEDEF}, {"union", TK_UNION}, {"unsigned", TK_UNSIGNED}, {"void", TK_VOID}, {"volatile", TK_VOLATILE}, {"while", TK_WHILE}, {NULL, 0}};
...
static Token scan(Lexer * lx)
{
    ...
    if (isdigit(c) || (c == '.' && isdigit(peek1(lx)))) {
        ...
        while (((((cur(lx) == 'u' || cur(lx) == 'U') || cur(lx) == 'l') || cur(lx) == 'L') || cur(lx) == 'f') || cur(lx) == 'F') {
            if (cur(lx) == 'f' || cur(lx) == 'F')
                is_float = 1;
    ...
    if (c == '\'') {
        ...
        if (cur(lx) == '\'') {
            ...
            lex_error(lx, "unterminated character literal");
...
static const char * KIND_NAMES[TK_COUNT + 1] = {[0] = "INVALID", [TK_IDENT] = "IDENT", [TK_INT_LIT] = "INT_LIT", [TK_FLOAT_LIT] = "FLOAT_LIT", [TK_CHAR_LIT] = "CHAR_LIT", [TK_STR_LIT] = "STR_LIT", [TK_AUTO] = "auto", [TK_BREAK] = "break", [TK_CASE] = "case", [TK_CHAR] = "char", [TK_CONST] = "const", [TK_CONTINUE] = "continue", [TK_DEFAULT] = "default", [TK_DO] = "do", [TK_DOUBLE] = "double", [TK_ELSE] = "else", [TK_ENUM] = "enum", [TK_EXTERN] = "extern", [TK_FLOAT] = "float", [TK_FOR] = "for", [TK_GOTO] = "goto", [TK_IF] = "if", [TK_INT] = "int", [TK_LONG] = "long", [TK_REGISTER] = "register", [TK_RETURN] = "return", [TK_SHORT] = "short", [TK_SIGNED] = "signed", [TK_SIZEOF] = "sizeof", [TK_STATIC] = "static", [TK_STRUCT] = "struct", [TK_SWITCH] = "switch", [TK_TYPEDEF] = "typedef", [TK_UNION] = "union", [TK_UNSIGNED] = "unsigned", [TK_VOID] = "void", [TK_VOLATILE] = "volatile", [TK_WHILE] = "while", [TK_LPAREN] = "(", [TK_RPAREN] = ")", [TK_LBRACE] = "{", [TK_RBRACE] = "}", [TK_LBRACKET] = "[", [TK_RBRACKET] = "]", [TK_SEMICOLON] = ";", [TK_COMMA] = ",", [TK_COLON] = ":", [TK_QUESTION] = "?", [TK_TILDE] = "~", [TK_DOT] = ".", [TK_ELLIPSIS] = "...", [TK_PLUS] = "+", [TK_PLUS_PLUS] = "++", [TK_PLUS_EQ] = "+=", [TK_MINUS] = "-", [TK_MINUS_MINUS] = "--", [TK_MINUS_EQ] = "-=", [TK_ARROW] = "->", [TK_STAR] = "*", [TK_STAR_EQ] = "*=", [TK_SLASH] = "/", [TK_SLASH_EQ] = "/=", [TK_PERCENT] = "%", [TK_PERCENT_EQ] = "%=", [TK_AMP] = "&", [TK_AMP_AMP] = "&&", [TK_AMP_EQ] = "&=", [TK_PIPE] = "|", [TK_PIPE_PIPE] = "||", [TK_PIPE_EQ] = "|=", [TK_CARET] = "^", [TK_CARET_EQ] = "^=", [TK_BANG] = "!", [TK_BANG_EQ] = "!=", [TK_EQ] = "=", [TK_EQ_EQ] = "==", [TK_LT] = "<", [TK_LT_LT] = "<<", [TK_LT_LT_EQ] = "<<=", [TK_LT_EQ] = "<=", [TK_GT] = ">", [TK_GT_GT] = ">>", [TK_GT_GT_EQ] = ">>=", [TK_GT_EQ] = ">=", [TK_HASH] = "#", [TK_EOF] = "EOF", [TK_UNKNOWN] = "UNKNOWN"};
...
int lexer_test(const char * filename)
{
    ...
    for (; ; ) {
        ...
        printf("%s:%d:%d\t%-16s\t|%s|\n", filename, t.line, t.col, token_kind_name(t.kind), t.text);
        count++;
        if (t.kind == TK_EOF)
            break;

        if (t.kind == TK_UNKNOWN) {
            lexer_free(lx);
            return 1;
        }
    }
