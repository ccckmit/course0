; ModuleID = '/Users/Shared/ccc/ccc114b/cccocw/_code/c0py/_data/test_union.c'
source_filename = "/Users/Shared/ccc/ccc114b/cccocw/_code/c0py/_data/test_union.c"
...
define dso_local i32 @test_union_basic() {
entry:
  %t0 = alloca [8 x i8]
  %t1 = getelementptr i8, ptr %t0, i64 0
  %t2 = sext i32 1094861636 to i64
  store i64 %t2, ptr %t1
...
define dso_local i32 @test_union_cast() {
entry:
  %t0 = alloca [8 x i8]
  %t1 = getelementptr i8, ptr %t0, i64 0
  %t2 = sext i32 65 to i64
  store i64 %t2, ptr %t1
  %t3 = getelementptr i8, ptr %t0, i64 0
  %t4 = load i64, ptr %t3
  %t5 = trunc i64 %t4 to i32
...
entry:
  %t0 = call i32 @test_union_basic()
  %t1 = sext i32 %t0 to i64
  %t2 = call i32 @test_union_cast()
