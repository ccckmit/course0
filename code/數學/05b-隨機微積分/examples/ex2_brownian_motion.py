"""
範例 2：布朗運動（Wiener Process）
===================================
示範：
  • 標準布朗運動路徑模擬
  • 布朗橋（固定端點）
  • Ornstein-Uhlenbeck 均值回歸
  • 各種統計性質驗證
"""
...
from stoc4py import BrownianMotion, OrnsteinUhlenbeck, BrownianBridge
from stoc4py.plot import StochPlot, _style, PALETTE, BG, TEXT, GRID
