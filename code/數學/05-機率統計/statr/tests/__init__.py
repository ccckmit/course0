"""Test suite for statr package"""

import pytest
from statr.distributions import dnorm, pnorm, qnorm, rnorm
from statr.stats import mean, median, var, sd
from statr.tests import t_test, z_test
