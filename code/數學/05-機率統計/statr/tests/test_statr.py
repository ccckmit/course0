"""Pytest tests for statr package"""

import pytest
import math

from statr.distributions import (
...
from statr.stats import mean, median, var, sd, cov, cor, quantile, summary, min_val, max_val
from statr.tests import t_test, z_test, chisq_test, anova, conf_interval
